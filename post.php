        ...
        header("Location:index.php");
                ...
                <div class="well">
                    ...
                    if(isset($_POST['create_comment']))
                    {
                        ...
                        {
                        $query = "INSERT INTO comments (comment_post_id , comment_author , comment_email , comment_content , comment_status , comment_date) VALUES ('{$the_post_id}','{$comment_author}','{$author_email}','{$comment_content}','unapproved','{$date}') ";
                ...
                confirmQuery($select_approved_comment);
                while($row=mysqli_fetch_assoc($select_approved_comment))
                {
